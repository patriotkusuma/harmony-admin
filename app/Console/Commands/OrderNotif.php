...
class OrderNotif extends Command
{
    /**
    ...
    use WaSender;
    protected $signature = 'order-notif';
                ...
                foreach($orders as $key => $value)
                {
                    ...
                    if($phone != ""){
                        ...
                        if($value->antar == 1){
                            ...
                            $message.= "Laundry dengan kode pesan *".$value->kode_pesan."* sudah selesai, apakah bisa kami antar sekarang ?\n\n\n";
                        }else {
                            $message .= "Laundry dengan kode pesan *".$value->kode_pesan."* sudah selesai dan sudah bisa diambil. \n\n\n";
                        }
